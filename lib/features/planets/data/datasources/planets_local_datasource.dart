...
abstract class PlanetsLocalDataSource {
  /// Gets the cached [List<PlanetModel>] in the local database
  ///
  /// Throws [NoLocalDataException] if no cached data is present.
  Future<List<PlanetModel>> getListOfPlanets();

  Future<void> cacheListOfPlanets(List<PlanetModel> planetToCache);
}
...
class PlanetsLocalDataSourceImpl implements PlanetsLocalDataSource {
  static const String tableSql = 'CREATE TABLE $_tableName('
      ...
      '$_url TEXT,'
      '$_image TEXT)';
  static const String _tableName = 'planets';
  ...
  @override
  Future<void> cacheListOfPlanets(List<PlanetModel> planetToCache) {
    return insertListOfPlanet(planetToCache);
  }
  ...
  Future<void> insertListOfPlanet(List<PlanetModel> listOfPlanetModel) async {
